...
//                dTambahUpdateRekening.dispose();
    ...
    private static String currency_convert(int nilai) {
    ...
    public static void loadkebijakan() {
        try {
            ...
            while (res.next()) {
                int komzet = res.getInt(2), bomzet = res.getInt(3);
                Komzet.setText(currency_convert(komzet));
                Bomzet.setText(currency_convert(bomzet));
