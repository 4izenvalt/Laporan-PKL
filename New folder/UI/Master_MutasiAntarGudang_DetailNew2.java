...
public class Master_MutasiAntarGudang_DetailNew2 extends javax.swing.JFrame {
    ...
    public Master_MutasiAntarGudang_DetailNew2(String no_bukti, boolean update, Master_MutasiAntarGudang awal) {
        ...
        tbl_tambah_mutasi.requestFocus(true);
//tbl_tambah_mutasi.
    ...
    void isi_jumlah_item_qty() {
        try {
            ...
            txt_jumlah_qty.setText("Jumlah Qty = " + format_double(String.valueOf(jumlah_qty), true));
            res.close();
            conn.close();
        } catch (Exception e) {
    ...
    void loadLihatDetail() {
        try {
            String sql = "select md.keterangan, bk.identitas_konversi, mdt.no_bukti, md.tanggal,mdt.kode_barang, mdt.nama_barang, asal.nama_lokasi as asal,k.nama_konversi,format(mdt.qty,2)as qty,tujuan.nama_lokasi as tujuan from mutasi_antar_gudang_detail mdt join mutasi_antar_gudang md \n"
    ...
    private void initComponents() {
        ...
        tbl_tambah_mutasi.setCellSelectionEnabled(true);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txt_jumlah_qty, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(139, 139, 139))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                ...
                for (int i = indeks_awal; i < jumlah_data; i++) {
                    ...
                    if (i == indeks_awal) {
                        for (int j = indeks_awal; j < jumlah_data; j++) {
                            ...
                            double qty = (Double)format_double(String.valueOf(tbl_tambah_mutasi.getValueAt(j, 5)), false);
                            //double qty = 1;
                            ...
                            while (res4.next()) {
                                ...
                                double stok = Double.parseDouble(res4.getString("jumlah"));
                    ...
                    if (!cukup) {
                        ...
                        double jumlah = (Double)format_double(String.valueOf(tbl_tambah_mutasi.getValueAt(i, 5)), false);
    ...
    void isi_qty_lama() {
        try {
            ...
            for (int i = 0; i < jumlah_data - 1; i++) {
                ...
                res1a.close();
                double qty = (Double)format_double(String.valueOf(tbl_tambah_mutasi.getValueAt(i, 5)), false);
...
//                            + "','" + lokasi_tujuan + "')";
        ...
        if (Hapus == 0) {
            ...
            for (int i = 0; i < rows.length; i++) {
                ...
                if (rows[i] == 0 || rows.length == 1) {
                    ...
                    txt_jumlah_qty.setText("Jumlah Qty = " + String.valueOf(String.format("$%,.2f", jumlah_qty)));
    ...
    private void tbl_tambah_mutasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbl_tambah_mutasiKeyPressed
        ...
        try {
            ...
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {    // Membuat Perintah Saat Menekan Enter
                if (tabelModel.getValueAt(tbl_tambah_mutasi.getSelectedRow(), 6).toString().equals("") || tabelModel.getValueAt(tbl_tambah_mutasi.getSelectedRow(), 5).toString().equals("") || tabelModel.getValueAt(tbl_tambah_mutasi.getSelectedRow(), 4).toString().equals("") || tabelModel.getValueAt(tbl_tambah_mutasi.getSelectedRow(), 3).toString().equals("") || tabelModel.getValueAt(tbl_tambah_mutasi.getSelectedRow(), 2).toString().equals("") || tabelModel.getValueAt(tbl_tambah_mutasi.getSelectedRow(), 1).toString().equals("")) {
                    ...
                    if (tbl_tambah_mutasi.getSelectedColumn() == 6) {
                        menambah_jumlah();
                        txt_jumlah_item.setText("Jumlah Item = " + String.valueOf(jumlah_item));
                        //txt_jumlah_qty.setText("Jumlah Qty = " + String.valueOf(String.format("%,d", jumlah_qty)));
                        txt_jumlah_qty.setText("Jumlah Qty = " + format_double(String.valueOf(jumlah_qty), true));
                        model.addRow(new Object[]{"", "", "", "", "", "", ""});
                    }
            ...
            } else if ((evt.getKeyCode() == KeyEvent.VK_1  || evt.getKeyCode() == KeyEvent.VK_NUMPAD2 )&& tbl_tambah_mutasi.getSelectedColumn() == 4) {
            ...
            } else if ((evt.getKeyCode() == KeyEvent.VK_2 || evt.getKeyCode() == KeyEvent.VK_NUMPAD2) && tbl_tambah_mutasi.getSelectedColumn() == 4) {
                System.out.println("ini alt");
                String kode_barang = String.valueOf(tbl_tambah_mutasi.getValueAt(tbl_tambah_mutasi.getSelectedRow(), 1));
                try {
            ...
            } else if ((evt.getKeyCode() == KeyEvent.VK_3 || evt.getKeyCode() == KeyEvent.VK_NUMPAD3) && tbl_tambah_mutasi.getSelectedColumn() == 4) {
                String kode_barang = String.valueOf(tbl_tambah_mutasi.getValueAt(tbl_tambah_mutasi.getSelectedRow(), 1));
                try {
