...
public class Master_Group extends javax.swing.JFrame {
 private Connect connection;
    ...
    public Master_Group(Connect connection) {
//        super(parent, modal);
        initComponents();
//        prep
...
//                    + "order by kode_pegawai";
            data = "SELECT kode_barang, nama_barang, harga_jual_1_barang, harga_jual_2_barang, harga_jual_3_barang, status_group "
                    + "FROM barang WHERE status_group = '1' "+ (param.equals("*") ? "" : "and nama_barang like '%" + param + "%' order by kode_barang");
            hasil = connection.ambilData(data);
            System.out.println("sukses query tampil tabel : "+data);
            setModel(hasil);
...
//            System.out.println(data);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(jcari, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(436, 436, 436)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jcari, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTable10.getSelectedRow() >= 0) {
          try {
//               Master_Group_DataGroup mgdg = new Master_Group_DataGroup(new Awal(rootPaneCheckingEnabled), rootPaneCheckingEnabled, listBarang, true);
...
//               kode.setText(model.getValueAt(i,1).toString());
               Master_Group_DataGroup mgdg = new Master_Group_DataGroup(connection, model.getValueAt(i,1).toString());
               mgdg.setLocationRelativeTo(this);
               mgdg.setVisible(true);
               mgdg.setFocusable(true);
    ...
    private void jTable10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable10MouseClicked
          this.listBarang = list.get(jTable10.getSelectedRow());
